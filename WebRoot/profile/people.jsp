...
<% 
		...
		String sql = "SELECT COUNT(*) _no FROM (SELECT user0_id,user1_id FROM friend WHERE true ";
		if(user_id==null){
		...
		sql = "SELECT f.user0_id,u0.name u0name,f.user1_id,u1.name u1name FROM friend f " +
