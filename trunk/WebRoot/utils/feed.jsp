...
<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
	...
	<tr>
		<td align="center" width="25%" style="font-size: 0.75em;"><a href="utils/rss.jsp<%if(request.getQueryString()!=null)out.print("?"+request.getQueryString());%>"><img border="0" src="images/rss_feed.gif" alt="RSS 2.0" /></a></td>
		<td align="center" width="25%" style="font-size: 0.75em;"><a href="utils/atom.jsp<%if(request.getQueryString()!=null)out.print("?"+request.getQueryString());%>"><img border="0" src="images/atom_feed.gif" alt="Atom" /></a></td>
		<td align="center" width="25%" style="font-size: 0.75em;"><a href="utils/ical.jsp<%if(request.getQueryString()!=null)out.print("?"+request.getQueryString());%>"><img border="0" style="height: 14px;width: auto;" src="images/ical.jpg" alt="iCal" /></a></td>
